...
<head>
    <meta charset="UTF-8">
    <title>Inbox | Josh Admin Template</title>
    ...
    <!--page level css -->
    <link href="{{ asset('backend/css/pages/alertmessage.css') }}" rel="stylesheet" />
    <link href="{{ asset('backend/css/pages/mail_box.css') }}" rel="stylesheet" type="text/css" />
    <!-- page level css ends-->
</head>
        ...
        <div class="navbar-right">
            <ul class="nav navbar-nav">
                    ...
                    <ul class="dropdown-menu dropdown-messages pull-right">
                        ...
                        <li class="unread message">
                            <a href="javascript:;" class="message"> <i class="pull-right" data-toggle="tooltip" data-placement="top" title="Mark as Read"><span class="pull-right ol livicon" data-n="adjust" data-s="10" data-c="#287b0b"></span></i>
                                <img src="{{ asset('backend/img/authors/avatar.jpg') }}" class="img-responsive message-image" alt="icon" />
                        ...
                        <li class="unread message">
                            <a href="javascript:;" class="message"> <i class="pull-right" data-toggle="tooltip" data-placement="top" title="Mark as Read"><span class="pull-right ol livicon" data-n="adjust" data-s="10" data-c="#287b0b"></span></i>
                                <img src="{{ asset('backend/img/authors/avatar1.jpg') }}" class="img-responsive message-image" alt="icon" />
                        ...
                        <li class="unread message">
                            <a href="javascript:;" class="message"> <i class="pull-right" data-toggle="tooltip" data-placement="top" title="Mark as Read">                                         <span class="pull-right ol livicon" data-n="adjust" data-s="10" data-c="#287b0b"></span>                                     </i>
                                <img src="{{ asset('backend/img/authors/avatar5.jpg') }}" class="img-responsive message-image" alt="icon" />
                                <div class="message-body"> <strong>Jenny Kerry</strong>
                                    <br>Dont forgot to call...
                                    <br> <small>An hour ago</small>
                                </div>
                            </a>
                        </li>
                        <li class="unread message">
                            <a href="javascript:;" class="message"> <i class="pull-right" data-toggle="tooltip" data-placement="top" title="Mark as Read">                                         <span class="pull-right ol livicon" data-n="adjust" data-s="10" data-c="#287b0b"></span>                                     </i>
                                <img src="{{ asset('backend/img/authors/avatar4.jpg') }}" class="img-responsive message-image" alt="icon" />
                                <div class="message-body"> <strong>Ronny</strong>
                                    <br>Hey! sup Dude?
                                    <br> <small>3 Hours ago</small>
                                </div>
                            </a>
                        </li>
                        <li class="footer">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('backend/img/authors/avatar3.jpg') }}" width="35" class="img-circle img-responsive pull-left" height="35" alt="riot">
                        <div class="riot">
                            <div>
                                Riot
                                <span>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header bg-light-blue">
                            <img src="{{ asset('backend/img/authors/avatar3.jpg') }}" width="90" class="img-circle img-responsive" height="90" alt="User Image" />
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a href="advanced_modals.html">
                                    <i class="fa fa-angle-double-right"></i> Advanced Modals
                                </a>
                            </li>
                            <li>
                                <a href="tagsinput.html"> <i class="fa fa-angle-double-right"></i> Tags Input </a>
                            </li>
                            <li>
                                <a href="nestable_list.html">
                                    <i class="fa fa-angle-double-right"></i> Nestable List
                                </a>
                            </li>
                            <li>
...
<script src="{{ asset('backend/js/pages/mail_box.js') }}" type="text/javascript"></script>
</body>
